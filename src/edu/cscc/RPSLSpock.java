...
/**
 * Main for the game rock paper scissors lizard spock
...
public class RPSLSpock {
    ...
    /**
     * string for comfirming if choice is valad
     * @param pick player pick
    ...
    /**
     * determines if computer has won the game
     * @param c_pick computer pick
     * @param h_pick human pick
     * @return true if computer has won game
     */
